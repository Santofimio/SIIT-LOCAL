<div class="container">
    ...
    <!-- /.content-header -->
    <h2 class="display-5 fw-bold text-center">Consultar Nivel De Programa</h2>
    <!-- Main content -->
        ...
        <div class="container-fluid">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-6">
                        <input type="text" class="form-control" id="buscar" placeholder="Buscar.." onkeyup="filtar('ProgramaNivel')">
                    </div>
                    <div class="col-3">
                        <a class="float-right" href="<?php echo getUrl("ProgramaNivel", "ProgramaNivel", "getCrear") ?>"><button class="btn btn-primary">CREAR</button></a>
                    </div>
                </div>
            </div>
            <div class="card-body">
