<div class="container">
    ...
    <section class="content">
        <div class="card card-warning">
            <div class="card-header">
                <h3 class="card-title">Registrar Tipo de Noticia</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="<?php echo getUrl("NoticiaTipo", "NoticiaTipo", "crear"); ?>" method="POST">
                <div class="card-body">
                    <div class="form-group">
                        <label for="title">Nombre Del Tipo de Noticia</label>
